...
CREATE TABLE `config`  (
  ...
  `searchKey` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `spiders`  (
  `sid` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
